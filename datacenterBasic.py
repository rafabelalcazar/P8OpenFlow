"""
You can launch this topology with:
sudo mn --custom datacenterBasic.py --topo dcbasic --mac --switch ovs --controller remote
But this exercise has these parameters: links = 100, delay = 5 ms, loss = 1
sudo mn --custom datacenterBasic.py --topo dcbasic --mac --switch ovs,protocols=OpenFlow13 --controller remote,ip=192.168.1.8 --link tc,delay=5ms,loss=1
So to create the topology make this:
